  ...
  <div class="container mx-auto bg-base-100">
    ...
    <div class="">
      ...
      <div class="dropdown m-4">
        ...
        <ul tabindex="0" class="dropdown-content menu rounded-box w-52 bg-neutral p-2 text-neutral-content">
          <li><a>Item 1</a></li>
          <li><a>Item 2</a></li>
        </ul>
      </div>
      ...
      <div class="modal">
        <div class="modal-box">
          <p>Enim dolorem dol4orum omnis atque necessitatibus. Consequatur aut adipisci qui iusto illo eaque. Consequatur repudiandae et. Nulla ea quasi eligendi. Saepe velit autem minima.</p>
